          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Jadwal Pelajaran</span></h5>
              </div>
                   ...
                   <div class="row">
                    <form action="{{ route('jadwals.update', $jadwal) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="input-field">
                        <input id="keterangan" type="text" name="keterangan" class="validate @error('keterangan') is-invalid @enderror" value="{{$jadwal->keterangan}}">
                      ...
                      <div class="input-field">
                        ...
                        <select class="form-control @error('tahun_id') is-invalid @enderror" id="tahun_id" name="tahun_id">
                            ...
                            <option value="{{$thn->id}}" {{ $jadwal->tahun_id == $thn->id ? 'selected' : '' }}>{{$thn->tahun}}
                            </option>
                            @endforeach
                        </select>
                        @error('tahun_id')
