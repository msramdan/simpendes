          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Data Mata Pelajaran</span></h5>
              </div>
              <div class="col s12 m6 l6 right-align-md">
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="#">Home</a>
                  </li>
                  <li class="breadcrumb-item active">Edit Data Mata Pelajaran
                  </li>
                </ol>
              </div>
            </div>
                   ...
                   <div class="row">
                    <form action="{{ route('mapels.update', $mapel) }}" method="POST" >
                      ...
                      <div class="input-field">
                        <input id="nama_mapel" type="text" name="nama_mapel" class="validate @error('nama_mapel') is-invalid @enderror" value="{{$mapel->nama_mapel}}">
