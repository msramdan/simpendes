          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Tambah Silabus</span></h5>
              </div>
              <div class="col s12 m6 l6 right-align-md">
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="#">Home</a>
                  </li>
                  <li class="breadcrumb-item active">Tambah Silabus
                  </li>
                </ol>
              </div>
            </div>
            ...
            <div class="section">
               <div class="card">
                 <div class="card-content">
                   <h4 class="card-title">Tambah Silabus</h4>
                   <br>
                   <div class="row">
                    <form action="{{ route('silabuss.store') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="input-field">
                        ...
                        <select class="form-control @error('mapel_id') is-invalid @enderror" id="mapel_id" name="mapel_id">
                            ...
                            <option value="{{$thn->id}}" {{old('id')== $thn->id ? 'selected' : ''}}>{{$thn->nama_mapel}}</option>
                            @endforeach
                        </select>
                      </div>
                      <div class="input-field">
