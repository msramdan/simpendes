          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Siswa</span></h5>
              </div>
            ...
            <div class="section">
               <div class="card">
                 <div class="card-content">
                   ...
                   <div class="row">
                    <a href="{{ route('exportsiswa') }}" class="btn waves-effect waves-light gradient-45deg-green-teal gradient-shadow">Export</a>
                    <a class="waves-effect waves-light btn modal-trigger gradient-45deg-green-teal gradient-shadow" href="#modal1">Import</a>
                    <a class="waves-effect waves-light btn modal-trigger gradient-45deg-green-teal gradient-shadow" href="file/Format Import Siswa.xlsx">Download Format Import</a>

                    <a href="{{ route('tambahdatasiswa') }}" class="right btn waves-effect waves-light gradient-45deg-light-blue-cyan gradient-shadow">Tambah Data</a>
                        <div class="col s12">
                           ...
                           <tbody>
                            ...
                            @foreach($data as $item)
                              <tr>
                                 ...
                                 <td> <img src="{{ asset('foto/profil_siswa/'. $item->foto ) }}" height="10%" width="10%"></td>
                                 <td>{{ $item->nisn }}</td>
                                 <td>{{ $item->nama_siswa }}</td>
                                 <td>{{date('d-m-Y', strtotime($item->tanggal_lahir)) }}</td>
                                 <td>{{ $item->kelas->nama_kelas }}</td>
                                 <td class="text-center" width="250px">
                                      <a href="{{ url('detailsiswa',$item->nipd) }}"><i class="material-icons">slideshow</i>
                                      </a> |
                                      <a href="{{ url('editdatasiswa',$item->nipd) }}"><i class="material-icons">edit</i>
                                      </a> |
                                      <a href="{{ url('deletedatasiswa',$item->nipd) }}" style="color: red;" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"><i class="material-icons">delete_forever</i>
                                      </a>
                                 </td>
                              </tr>
                              @endforeach
