          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Tambah Data Tahun Ajaran</span></h5>
              </div>
              <div class="col s12 m6 l6 right-align-md">
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="#">Home</a>
                  </li>
                  <li class="breadcrumb-item active">Tambah Data Tahun Ajaran
                  </li>
                </ol>
              </div>
            </div>
                   ...
                   <div class="row">
                    <form action="{{ route('tahuns.store') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="input-field">
                        <input id="tahun" type="text" name="tahun" class="validate" required>
